import { transformCampaignData } from './transforms';
...
describe('transformCampaignData', () => {
  ...
  it('transforms campaign data correctly', () => {
    const transformed = transformCampaignData([mockCampaign]);
  ...
  it('handles empty campaign array', () => {
    const transformed = transformCampaignData([]);
  ...
  it('handles different campaign types', () => {
    ...
    const [transformedVisit] = transformCampaignData([visitCampaign]);
    const [transformedDelivery] = transformCampaignData([deliveryCampaign]);
